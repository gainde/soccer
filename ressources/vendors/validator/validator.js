...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : 'Ce champ ne doit pas être vide',
        min             : 'saisie trop court',
        max             : 'saisie trop long',
        number_min      : 'trop petit',
        number_max      : 'trop long',
        url             : 'URL invalide',
        number          : ' doit être un nombre',
        email           : 'adresse email invalide',
        email_repeat    : 'emails ne matche pas',
        password_repeat : 'le mot de passe ne matche pas',
        repeat          : 'Pas de match',
        complete        : 'Saisie icomplete.',
        select          : 'SVP choisir un option'
    };
